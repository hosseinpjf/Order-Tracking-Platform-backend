"""Categories model updated

Revision ID: 512b25019688
Revises: 5ed7c8cef72f
Create Date: 2026-07-27 01:04:52.225314
...
revision: str = '512b25019688'
down_revision: Union[str, Sequence[str], None] = '5ed7c8cef72f'
...
def upgrade() -> None:
    ...
    op.drop_index(op.f('ix_site_contents_type'), table_name='site_contents')
...
def downgrade() -> None:
    ...
    sa.Column('icons', sqlite.JSON(), nullable=True),
    sa.Column('buttons', sqlite.JSON(), nullable=True),
    ...
    op.create_index(op.f('ix_site_contents_type'), 'site_contents', ['type'], unique=False)
    ...
    sa.Column('slogans', sqlite.JSON(), nullable=True),
    sa.Column('logo', sa.VARCHAR(), nullable=True),
    sa.Column('address', sa.VARCHAR(), nullable=True),
    sa.Column('location', sqlite.JSON(), nullable=True),
    sa.Column('phones', sqlite.JSON(), nullable=True),
    sa.Column('links', sqlite.JSON(), nullable=True),
    sa.Column('working_hours', sqlite.JSON(), nullable=True),
    sa.Column('today_suggestions', sqlite.JSON(), nullable=True),
    sa.Column('settings', sqlite.JSON(), nullable=True),
    sa.Column('table_reservation_time', sa.INTEGER(), nullable=True),
    sa.Column('hero', sqlite.JSON(), nullable=True),
    sa.Column('footer', sqlite.JSON(), nullable=True),
    sa.Column('about_us', sqlite.JSON(), nullable=True),
    sa.Column('contact_us', sqlite.JSON(), nullable=True),
    sa.Column('created_at', sa.DATETIME(), nullable=True),
    sa.Column('updated_at', sa.DATETIME(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('receiver_id', sa.VARCHAR(), nullable=False),
    sa.Column('content', sa.VARCHAR(length=5000), nullable=False),
    sa.Column('reply_to_message_id', sa.VARCHAR(), nullable=True),
