"""site_info model updated

Revision ID: 97d4a9c306b9
Revises: c95c5e86754e
Create Date: 2026-07-18 05:53:16.255507
...
revision: str = '97d4a9c306b9'
down_revision: Union[str, Sequence[str], None] = 'c95c5e86754e'
...
def downgrade() -> None:
    ...
    sa.Column('id', sa.VARCHAR(), nullable=False),
    sa.Column('name', sa.VARCHAR(length=50), nullable=False),
    sa.Column('slogan', sqlite.JSON(), nullable=True),
